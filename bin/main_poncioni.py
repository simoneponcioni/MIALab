...
def main(result_dir: str, data_atlas_dir: str, data_train_dir: str, data_test_dir: str):
    ...
    for img in images_test:
        ...
        evaluator.evaluate(
            image_prediction, img.images[structure.BrainImageTypes.GroundTruth], img.id_
        )
    ...
    images_post_processed = putil.post_process_batch(
        images_test,
        images_prediction,
        images_probabilities,
        post_process_params,
    ...
    writer.CSVStatisticsWriter(result_summary_file, functions=functions).write(
        evaluator.results
    )
